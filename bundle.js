...
(()=>{
    ...
    var e = {
        28: (e,n,t)=>{
            ...
            var r = t(81)
              ...
              , a = t(645)
              , o = t.n(a)()(l());
            o.push([e.id, "* {\n  box-sizing: border-box;\n  margin: 0;\n  padding: 0;\n  font-family: 'Kalam', cursive;\n}\n\n/* body {\n  margin: 0;\n  padding: 0;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n  background-color: #f9f9f9;\n} */\n\n/* Typography */\n/* h1, h2, h3, h4, h5, h6 {\n  margin-top: 20px;\n  margin-bottom: 10px;\n  color: #333;\n}\n\nh1 {\n  font-size: 2.5rem;\n}\n\nh2 {\n  font-size: 2rem;\n}\n\nh3 {\n  font-size: 1.8rem;\n}\n\nh4 {\n  font-size: 1.6rem;\n}\n\nh5 {\n  font-size: 1.4rem;\n}\n\nh6 {\n  font-size: 1.2rem;\n} */\n\n/* Tables */\n/* table {\n  width: 80%;\n  max-width: 800px;\n  border-collapse: collapse;\n  margin-bottom: 40px;\n  box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);\n  border-radius: 8px;\n}\n\nth, td {\n  border: 2px solid #e0e0e0;\n  padding: 12px 32px;\n  text-align: center;\n}\n\nth {\n  background-color: #f5f5f5;\n  font-weight: bold;\n} */\n\n/* Forms */\n\n/* Buttons */\n/* button {\n  padding: 12px 18px;\n  background-color: #007bff;\n  color: #fff;\n  border: none;\n  border-radius: 5px;\n  cursor: pointer;\n  transition: background-color 0.3s ease-in-out;\n  font-size: 1rem;\n}\n\nbutton:hover {\n  background-color: #0056b3;\n}\n\n.name-box {\n  background-color: #639b5d;\n  color: #ddd;\n}\n\n.price-box {\n  background-color: #d44d4d;\n  color: #ddd;\n}\n\n.fruit-box {\n  background-color: #acabab8a;\n} */\nhtml{\n  background-color: white;\n}\n\nbody{\n  margin: 50px auto;\n  padding: 50px 50px;\n  text-align: center;\n  font-size: 14px;\n  background: url(https://images.pexels.com/photos/4022107/pexels-photo-4022107.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1);\n  background-size: cover;\n  background-repeat: no-repeat;\n  background-position: center;\n  border-radius: 5px;\n  overflow: hidden;\n  width: 500px;\n}\n\n.filterable-product-table {\n  max-width: 600px;\n  margin: 20px auto;\n  padding: 10px;\n  /* border: 5px solid #ddd; */\n  border-radius: 5px;\n  box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);\n  background-color: rgba(240, 242, 217, 0.9);\n}\n\n.search-bar {\n  margin-bottom: 10px;\n}\n\n.product-table {\n  width: 100%;\n  border-collapse: collapse;\n}\n\n.product-table th, .product-table td {\n  padding: 10px;\n  border: 2px solid orange;\n  text-align: left;\n}\n\n.product-table th {\n  background-color: #f2f2f2;\n}\n\n.category-row {\n  background-color: #e0e0e0;\n}\n\n.product-row span {\n  color: red;\n}\n", ""]);
            const u = o
        }
        ,
        645: e=>{
        ...
        448: (e,n,t)=>{
            ...
            var Ei, Ci = Math.ceil, _i = k.ReactCurrentDispatcher, Pi = k.ReactCurrentOwner, Ni = k.ReactCurrentBatchConfig, zi = 0, Ti = null, Li = null, Mi = 0, Ri = 0, Oi = El(0), Fi = 0, Ii = null, Di = 0, Ui = 0, Ai = 0, Vi = null, $i = null, ji = 0, Bi = 1 / 0, Hi = null, Wi = !1, Qi = null, qi = null, Ki = !1, Yi = null, Xi = 0, Gi = 0, Zi = null, Ji = -1, es = 0;
            function ns() {
    ...
    (()=>{
        ...
        const r = function(n) {
            ...
            }), e.createElement("label", null, e.createElement("br", null), e.createElement("br", null), e.createElement("input", {
                type: "checkbox",
                checked: r,
                onChange: function(e) {
          ...
          , o = function(n) {
            var t = n.products
              ...
              , i = t.filter((function(e) {
                return -1 !== e.name.toLowerCase().indexOf(r.toLowerCase()) && !(o && !e.stocked)
            }
            )).map((function(n) {
                var t = n.category !== u ? e.createElement(l, {
                    category: n.category,
                    key: n.category
                }) : null;
                return u = n.category,
            ...
            }, e.createElement("thead", null, e.createElement("tr", null, e.createElement("th", null, "Name"), e.createElement("th", null, "Price"))), e.createElement("tbody", null, i))
        };
        function u(e, n) {
            return function(e) {
                if (Array.isArray(e))
        ...
        n.createRoot(document.getElementById("root")).render(e.createElement(C, null))
    }
    )()
}
)();
